...
public final class SkyAntiCheatPlugin extends JavaPlugin implements PlatformLoader {

    public static SkyAntiCheatPlugin LOADER;
    ...
    public void onEnable() {
        ...
        // Violation log GUI (/skyac logs <player>)
    ...
    public void registerAPIService() {
        ...
        eventBus.subscribe(context, ac.grim.grimac.api.event.events.GrimReloadEvent.class, (event) -> {
            ...
            // /skyac reload only reloads Grim's own config — afk.yml is a separate
        ...
        Bukkit.getServicesManager().register(GrimAbstractAPI.class, externalAPI, SkyAntiCheatPlugin.LOADER, ServicePriority.Normal);
    }
