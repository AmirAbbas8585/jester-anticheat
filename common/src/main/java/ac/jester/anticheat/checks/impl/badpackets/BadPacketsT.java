...
public class BadPacketsT extends Check implements PacketCheck {
    ...
    public BadPacketsT(final GrimPlayer player) {
        ...
        // 1.8 is the top of a standing hitbox. GSit "sit on a player's head"
        // makes you click the very top of their head (the hat layer reaches
        // ~2.0), so allow a little above the hitbox to avoid flagging it.
        maxVerticalDisplacement = 2.0001 + expansion;
    }

    @Override
    public void onPacketReceive(final PacketReceiveEvent event) {
        // Riding something (a GSit seat, sitting on a player's head, any vehicle)
        // makes your interaction geometry legitimately weird — don't hitbox-check
        // interactions while mounted. This is the GSit player-sit false positive.
