...
/**
 * /skyac check <player> [limit] — shows recent in-memory alerts for a player.
 *
 * Unlike /skyac history (database), this shows live session data without
 * requiring the database to be enabled.
 */
public class SkyCheck implements BuildableCommand {
