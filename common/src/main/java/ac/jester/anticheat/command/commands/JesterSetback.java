...
/**
 * /jester setback <player> — force-setbacks a player to their last safe position.
 */
public class JesterSetback implements BuildableCommand {
