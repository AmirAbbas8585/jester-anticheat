...
/**
 * /jester freeze <player> — toggle: freezes the target if free, unfreezes if frozen.
 * (The old separate /jester unfreeze is kept as an alias of the same toggle.)
 */
public class JesterFreeze implements BuildableCommand {
