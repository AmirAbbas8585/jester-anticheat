...
/**
 * /jester stats — shows server-wide anticheat statistics.
 */
public class JesterStats implements BuildableCommand {
                ...
                MessageUtil.replacePlaceholders(sender,
                        GrimAPI.INSTANCE.getConfigManager().getConfig()
                                .getStringElse("stats-header",
                                        "%prefix% &bJesterAntiCheat &8— &fServer Statistics"))));
