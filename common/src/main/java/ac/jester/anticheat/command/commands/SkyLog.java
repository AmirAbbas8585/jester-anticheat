...
public class SkyLog implements BuildableCommand {
    ...
    private static void sendLog(Sender sender, String log, String success, String failure, Consumer<String> consumer, String type) throws IOException {
        ...
        try {
            ...
            urlConn.addRequestProperty("User-Agent", "SkyAC/" + GrimAPI.INSTANCE.getExternalAPI().getGrimVersion());
    ...
    public void register(CommandManager<Sender> commandManager, CloudCommandAdapter adapter) {
        ...
        // command (SkyLogs, the violation log GUI). "gl" remains as the shortcut.
        Command<Sender> command = commandManager.commandBuilder("skyac", "sac", "jester", "jac")
                .literal("log")
                .permission("skyac.log")
