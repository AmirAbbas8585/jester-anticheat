...
public class SkyDump implements BuildableCommand {
    ...
    private void handleDump(@NotNull CommandContext<Sender> context) {
        ...
        SkyLog.sendLogAsync(sender, generateDump(), string -> link = string, "text/yaml");
    }
    ...
    private static JsonObject getBuildInfo() {
        ...
        try {
            Properties properties = PropertiesUtil.readProperties(GrimAPI.INSTANCE.getClass(), "SkyAC.properties");
