...
public class MessageUtil {
    ...
    // Bare hex like '#ff7109' (no prefix). Lookbehind keeps MiniMessage
    // tags intact: '<color:#ff7109>' and '<#ff7109>' must not be re-wrapped.
    ...
    private @Nullable String replacePlaceholders(@Nullable GrimPlayer grimPlayer, @Nullable PlatformPlayer platformPlayer, @Nullable String string, boolean removeFormatting) {
        ...
        do {
            ...
            // removeFormatting (Discord markdown escaping) was removed along with webhook support
    ...
    /**
     * Converts a config string (MiniMessage tags and/or legacy & codes) into
     * plain text with legacy § codes. Use for strings consumed as raw text by
     * external commands — e.g. console-dispatched punishments like /kick,
     * whose reason would otherwise display MiniMessage tags literally.
     */
