...
public class GrimPlayer implements GrimUser {
    ...
    public final ac.jester.anticheat.checks.impl.packetorder.PacketOrderProcessor packetOrderProcessor =
            new ac.jester.anticheat.checks.impl.packetorder.PacketOrderProcessor(this);
    ...
    public GrimPlayer(@NotNull User user) {
        ...
        fireworks = new CompensatedFireworks(this);
