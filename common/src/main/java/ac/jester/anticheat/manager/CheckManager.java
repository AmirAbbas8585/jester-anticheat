...
public class CheckManager {
    ...
    public CheckManager(GrimPlayer player) {
        ...
        ImmutableClassToInstanceMap.Builder<PacketCheck> packetChecksBuilder = new ImmutableClassToInstanceMap.Builder<PacketCheck>()
                ...
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderProcessor.class, player.packetOrderProcessor)
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderB.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderB(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderC.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderC(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderD.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderD(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderO.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderO(player))
                ...
                .put(ac.jester.anticheat.checks.impl.combat.TeleportHit.class,
                        new ac.jester.anticheat.checks.impl.combat.TeleportHit(player))
        ...
        packetChecksBuilder.put(SetbackBlocker.class, new SetbackBlocker(player));
        ...
        postPredictionChecks = new ImmutableClassToInstanceMap.Builder<PostPredictionCheck>()
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderA.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderA(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderE.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderE(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderF.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderF(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderG.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderG(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderH.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderH(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderI.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderI(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderJ.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderJ(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderK.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderK(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderL.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderL(player))
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderM.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderM(player))
                ...
                .put(SetbackTeleportUtil.class, new SetbackTeleportUtil(player))
        ...
        blockPlaceChecks = new ImmutableClassToInstanceMap.Builder<BlockPlaceCheck>()
                .put(ac.jester.anticheat.checks.impl.packetorder.PacketOrderN.class, new ac.jester.anticheat.checks.impl.packetorder.PacketOrderN(player))
